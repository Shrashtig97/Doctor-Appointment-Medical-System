...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="index.php">Medical Store</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      ...
      <li class="nav-item">
          <a class="nav-link active" onClick="location.href='../MedikitHealthCare.php'"><i class="fa fa-home mr-1"></i>Home</a>
        </li>
        <li class="nav-item">
